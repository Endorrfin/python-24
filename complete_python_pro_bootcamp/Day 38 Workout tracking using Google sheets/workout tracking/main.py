...
# 1️⃣ CREATE OWN GOOGLE SHEET: https://docs.google.com/spreadsheets/d/11n4OUVML9DDK9uCTAGytQJHtXYOVq36DO3eMqg-jto0/edit?gid=0#gid=0
# 2️⃣ Go to the Nutritionix API website and select "Get Your API Key"
# 3️⃣ Get Exercise Stats with Natural Language Queries
# 4️⃣ Setup Your Google Sheet with Sheety
# 5️⃣ Saving Data into Google Sheets
# 6️⃣ Authenticate Your Sheety API
# 7️⃣ Environment Variables


# APP_ID = 'c542e71c'
# API_KEY = 'c1dedf8d91eb1457edb7d5e1464469f9'
